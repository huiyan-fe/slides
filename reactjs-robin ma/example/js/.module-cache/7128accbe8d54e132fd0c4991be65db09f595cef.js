(function(){
  ...
  var UserInput = React.createClass({displayName: "UserInput",
    ...
    inputUsername: function (e) {
      var name = this.currentTarget.value;
    ...
    render: function () {
      return (
        React.createElement("div", null, 
          React.createElement("div", null, 
            React.createElement("input", {name: "username", value: "{this.state.username}", onChange: this.inputUsername}), React.createElement("button", {onClick: this.addUser}, "click")
          ), 
